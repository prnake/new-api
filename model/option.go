...
func InitOptionMap() {
	...
	common.OptionMap["AutomaticNoRetryKeywords"] = operation_setting.AutomaticNoRetryKeywordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AutomaticNoRetryKeywords":
		operation_setting.AutomaticNoRetryKeywordsFromString(value)
